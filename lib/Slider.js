...
var propTypes = {
  ...
  validateMove: _propTypes2['default'].func,
  // the values
  ...
  _createClass(Rheostat, [{
    ...
    value: function () {
      function validatePosition(idx, proposedPosition) {
        ...
        var validateMove = this.props.validateMove;


        var nextPos = Math.max(Math.min(proposedPosition, handlePos[idx + 1] !== undefined ? handlePos[idx + 1] - handleDimensions : SliderConstants.PERCENT_FULL // 100% is the highest value
